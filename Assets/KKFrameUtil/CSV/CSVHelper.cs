...
namespace KK.Frame.Util
{
    ...
    {        
        ...
        public static List<CsvRow> ParseCSV_Exp(string pathNameInResource)
        {
            ...
            CsvFileReader reader = new CsvFileReader(new MemoryStream(datas));
        ...
        public static List<CsvRow> ParseCSV(string pathNameInResource, OnResourceLoaded onResourceLoaded = null, bool isRequest = false)
        {
            string text;
#if UNITY_EDITOR
            //FileStream fileStream = File.OpenRead(Application.dataPath + "/Resources/GameConfig/" + pathNameInResource + ".csv");
            ...
            //streamReader.Close();
            //fileStream.Close();
            TextAsset mytxt = (TextAsset)Resources.Load("GameConfig/" + pathNameInResource);
            text = mytxt.text;
#elif UNITY_ANDROID
			TextAsset mytxt=(TextAsset) Resources.Load("GameConfig/"+pathNameInResource);
			text=mytxt.text;
