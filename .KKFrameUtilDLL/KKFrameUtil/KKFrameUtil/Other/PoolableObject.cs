...
public class PoolableObject : MonoBehaviour
{
    ...
    public bool sendWithChildren = true;
    ...
    internal class ObjectPool
    {
        ...
        internal void _SetAvailable( PoolableObject poolObj, bool b )
        {
            ...
            if ( b )
            {
                ...
                objTransform.SetParent(null);// = null; // object could still be parented, so detach
            ...
            {
                objTransform.SetParent(null);// = null; // detach from poolParentDummy
        ...
        private void _SetActiveAndSendMessages( GameObject obj, PoolableObject parentPoolObj )
        {
            ...
            {
                if (parentPoolObj.sendWithChildren)
                {
